#!/usr/bin/env node
/**
 * Ports the 8 posts from ../ark-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'ark-blog', 'src', 'content', 'posts');
...
const file = `/* Auto-generated by scripts/port-from-ark-blog.mjs — do not edit by hand. */
