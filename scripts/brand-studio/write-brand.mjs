...
export function validateBrandPayload(body) {
	...
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/ark-cheats-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/ark-hero-banner.webp');
