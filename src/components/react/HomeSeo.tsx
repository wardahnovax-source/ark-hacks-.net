	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/ark-dino-esp/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/ark-ascended-hacks/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/ark-ascended-hacks/', labelKey: 'homeSeo.linkARKCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
