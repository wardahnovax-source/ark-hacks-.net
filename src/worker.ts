 ...
 * Canonical site: https://arkhacks.net (matches brand.url)
 *
 * Requires DNS: CNAME `www` → `arkhacks.net` (proxied) AND
 * Workers custom domain `www.arkhacks.net` attached — otherwise
...
const CANONICAL_HOST = 'arkhacks.net';

/** Old apex still 301 → current canonical. */
const LEGACY_HOSTS = new Set(['bestarkcheats.com', 'www.bestarkcheats.com']);
